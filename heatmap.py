...
def get_params():
    params = {
        'weight': 'runs/detect/yolov8n+RFA+C3RFEM/weights/best.pt',  # 训练出来的权重文件
        'cfg': 'yolov8n-RFA-C3RFEM.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r"D:\A_1\Dataset\tmptest\p4.jpg", 'result/RFARFE-p4')  # 第一个是检测的文件, 第二个是保存的路径